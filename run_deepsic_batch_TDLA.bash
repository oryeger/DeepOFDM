...
#SBATCH --array=0-24                 ### run parallel 5 times
...
config_files=("TDL_A_1.yaml" "TDL_A_2.yaml" "TDL_A_3.yaml"  "TDL_A_4.yaml" "TDL_A_5.yaml" "TDL_A_6.yaml" "TDL_A_7.yaml" "TDL_A_8.yaml" "TDL_A_9.yaml" "TDL_A_10.yaml" "TDL_A_11.yaml"  "TDL_A_12.yaml" "TDL_A_13.yaml" "TDL_A_14.yaml" "TDL_A_15.yaml" "TDL_A_16.yaml" "TDL_A_17.yaml" "TDL_A_18.yaml"  "TDL_A_19.yaml" "TDL_A_20.yaml" "TDL_A_21.yaml" "TDL_A_22.yaml"  "TDL_A_23.yaml" "TDL_A_24.yaml" "TDL_A_25.yaml")
