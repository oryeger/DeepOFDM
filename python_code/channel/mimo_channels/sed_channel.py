...
class SEDChannel:
    ...
    def transmit(s: np.ndarray, h: np.ndarray, snr: float, num_res: int, go_to_td: bool, cfo: int, cfo_and_clip_in_rx: bool, n_users: int) -> np.ndarray:
        ...
        axes[0].plot(20 * np.log10(np.abs(y[0, 3, :])), '-', color='g', label='Ant 0')
        axes[0].plot(20 * np.log10(np.abs(y[1, 3, :])), '-', color='r', label='Ant 1')
        axes[0].plot(20 * np.log10(np.abs(y[2, 3, :])), '-', color='k', label='Ant 2')
        axes[0].plot(20 * np.log10(np.abs(y[3, 3, :])), '-', color='b', label='Ant 3')
        ...
        axes[1].plot(20 * np.unwrap(np.angle(y[0, 3, :])), '-', color='g', label='Ant 0')
        axes[1].plot(20 * np.unwrap(np.angle(y[1, 3, :])), '-', color='r', label='Ant 1')
        axes[1].plot(20 * np.unwrap(np.angle(y[2, 3, :])), '-', color='k', label='Ant 2')
        axes[1].plot(20 * np.unwrap(np.angle(y[3, 3, :])), '-', color='b', label='Ant 3')
        ...
        axes[0].plot(20 * np.log10(np.abs(y_ce[0,0, 3, :])), '-', color='g', label='Ant 0')
        axes[0].plot(20 * np.log10(np.abs(y_ce[0,1, 3, :])), '-', color='r', label='Ant 1')
        axes[0].plot(20 * np.log10(np.abs(y_ce[0,2, 3, :])), '-', color='k', label='Ant 2')
        axes[0].plot(20 * np.log10(np.abs(y_ce[0,3, 3, :])), '-', color='b', label='Ant 3')
        axes[0].set_xlabel('Subcarrier')
        axes[0].set_ylabel('Amp (dB)')
        axes[0].set_title('TDL-'+conf.TDL_model+', delay spread='+str(int(round(float(conf.delay_spread)*1e9)))+' nsec', fontsize=10)
        axes[0].legend()
        ...
        axes[1].plot(20 * np.unwrap(np.angle(y_ce[0,0, 3, :])), '-', color='g', label='Ant 0')
        axes[1].plot(20 * np.unwrap(np.angle(y_ce[0,1, 3, :])), '-', color='r', label='Ant 1')
        axes[1].plot(20 * np.unwrap(np.angle(y_ce[0,2, 3, :])), '-', color='k', label='Ant 2')
        axes[1].plot(20 * np.unwrap(np.angle(y_ce[0,3, 3, :])), '-', color='b', label='Ant 3')
        axes[1].set_xlabel('Subcarrier')
        axes[1].set_ylabel('Phase (Rad)')
