...
make_64QAM_16QAM_percentage_vals=(0 50 100)
                          ...
                          for mod_pilot in "${mod_pilot_vals[@]}"; do
                            ...
                            for prime_make16 in "${prime_QPSK_make_16QAM_vals[@]}"; do
                              ...
                              for snr in "${snrs[@]}"; do
                                ...
                                out_file="${base_name}_cfo${cfo}_clip${clip}_${uf}_${aug}_${ttag}_${ktag}_${ptag}_${mtag}_${utag}_${mptag}_${mixtag}_${p4m16}_${ovtag}_${tdtag}_s${seed}_snr${snr}.yaml"
